...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "DengageTest123.Android.dll" comes first in this list. */
		"DengageTest123.Android.dll",
		"Dengage.Android.Binding.dll",
		"DengageSDK.Xamarin.Android.dll",
		"DengageSDK.Xamarin.Core.dll",
		"DengageTest123.dll",
		"FormsViewGroup.dll",
		"GoogleGson.dll",
